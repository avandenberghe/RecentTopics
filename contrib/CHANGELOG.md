...
- 3.0.8 (15/04/2026)
  - [NEW] Added the ability to display recent topics on top/bottom of the viewforum page (viewforum.php), in addition to the existing index page placement. see https://www.phpbb.nl/forums/viewtopic.p ... 35#p475235 for the request (#178)
