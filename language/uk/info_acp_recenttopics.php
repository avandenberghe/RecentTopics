...
$lang = array_merge(
	...
	'RT_PAGE_NUMBER_EXP'            => 'Можна відображати більшу кількість останніх тем, розбиваючи список на сторінки. Якщо встановлено значення 0, список буде складатися зі стількох сторінок, скільки необхідно для відображення всіх тем на форумі (не рекомендується).',
