...
$lang = array_merge(
	...
	'RT_TOPIC_LINK_TO'              => 'Посилання заголовка теми веде на',
	'RT_TOPIC_LINK_TO_EXP'          => 'Оберіть, на яке повідомлення веде посилання заголовка теми в списку останніх тем.',
	...
	'RT_PAGE_ENABLE'                => 'Увімкнути автономні сторінки',
	'RT_PAGE_ENABLE_EXP'            => 'Дозволити доступ до автономних сторінок нещодавніх тем. Це не залежить від відображення на головній сторінці.',
